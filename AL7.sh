...
echo  "      xx  xx  xx        xxxxxxxxxxxxxxxxxxxxxxxx              ";
echo  "      xx  xx  xx        x xxxxxxxxxxxxxxxxxxxxxxxx            ";
echo  "      xx  xx  xx        x    xxxxxxxxxxxxxxxxxxxx   x         ";
echo  "      xx  xx  xx        x        xxxxxxxxxxxxxxx              ";
echo  "      xx  xx  xx       x             xxxxxxxxx               ";
echo  "      xx  xx  xx      x                                      ";
echo ""
...
echo -e $red "                  $purple<<<$white The Script By: Abde Lbari >>>"
echo ''
echo -e $white " Follow me :"
echo            "  ^^^^^^^^^^^"
echo -e $blue " Telegram: @AbdeLbari404           |            Instagram: abde__lbarii"
echo            "  -----------------------                        -----------------------"
echo -e $blue " Github: Abde-Lbari              |            Facebook: Abde Lbari"
echo            "  -----------------------                        -----------------------"
echo -e $white "         }--------------------------------------------------{"
echo ''
